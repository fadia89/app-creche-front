        ...
        <div className="max-w-5xl mx-auto my-12 px-6 py-10 bg-gray-100 rounded-lg shadow text-gray-800">
            ...
            <div className="space-y-8 text-sm sm:text-base leading-relaxed">
                ...
                <section className="border-t pt-6">
                    ...
                    <p><strong>Adresse :</strong> 98 rue Didot, 75014 Paris</p>
                    <p><strong>Téléphone :</strong> +33 1 44 43 11 00</p>
                    <p><strong>Email :</strong> contact@creche-oursonsetcompagnie.fr</p>
